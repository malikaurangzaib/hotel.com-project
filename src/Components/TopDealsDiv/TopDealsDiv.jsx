...
function TopDealsSection() {
  ...
  // if (dealsData.filter((deal)=> deal.rating <5).length <1){
  //   return null
  // }


  return (
    <div className="topDeals-carousel-section">
      <h2 className="topDeals-carousel-title">Top deals for a last minute getaway 
        <div className="seeAllDeals-btn"> <GeneralBtn label="See all deals "/> </div> </h2>
        
      <p className="topDeals-carousel-subtitle">
        Showing deals for: <span> 12 Sept - 14 Sept</span>
      </p>

      <div className="topDeals-carousel-container">
        {showLeft && (
          <button className="topDeals-carousel-btn left" onClick={() => scroll("left")}>
            <svg
       ...
       <div
        className="topDeals-carousel-track"
        ref={carouselRef}
        onScroll={handleScroll}
      >
        {dealsData
        // .filter((deal) => deal.topDeal) 
        .map((deal) => (
        ...
        {showRight && (
          <button
            className="topDeals-carousel-btn right"
